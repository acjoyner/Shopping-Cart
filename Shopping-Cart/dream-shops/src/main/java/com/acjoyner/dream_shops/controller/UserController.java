...
import com.acjoyner.dream_shops.dto.UserDto;
...
import com.acjoyner.dream_shops.request.CreateUserRequest;
import com.acjoyner.dream_shops.request.UserUpdateRequest;
...
public class UserController {
    ...
    public ResponseEntity<ApiResponse> updateUser(@RequestBody UserUpdateRequest request, @PathVariable Long userId){
        try {
            User user = userService.updateUser(request, userId);UserDto userDto = userService.convertUserToDto(user);
